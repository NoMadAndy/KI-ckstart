...
Die Übungen mit dem Smartphone (Prompts zum Kopieren, Eliza-Miniatur, Mensch-oder-Modell) liegen unter `handy/` und werden per GitHub Pages ausgeliefert: https://nomadandy.github.io/KI-ckstart/handy/ – der QR-Code dafür ist `trainer/qr_handy.png`.
